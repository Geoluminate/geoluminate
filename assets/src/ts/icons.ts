...
import { faArrowRightToBracket, faBarsStaggered, faBell, faBook, faBookOpen, faComments, faDatabase, faDoorOpen, faEllipsisV, faEnvelope, faFileCode, faFileContract, faFileZipper, faFlag, faFlask, faFolderOpen, faGears, faHouseLock, faInstitution, faLink, faMagnifyingGlassChart, faMapLocationDot, faMapMarkerAlt, faPencil, faPlus, faProjectDiagram, faRightFromBracket, faRightToBracket, faRss, faShare, faSpinner, faUser, faUsers } from '@fortawesome/free-solid-svg-icons'
