...
class DatatablesORJSONRenderer(ORJSONRenderer):
    """This class is an integration of drf_orjson_renderer.renderers.ORJSONRenderer and
    rest_framework_datatables_editor.renderers.DatatablesRenderer. It provides
