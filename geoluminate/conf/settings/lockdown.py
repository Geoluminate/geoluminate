"""Geoluminate allows you to lockdown your entire site with a password or restrict access to staff or superusers only. To enable this feature, you must set one of the following environment variables:
