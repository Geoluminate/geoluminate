            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="proposed_start",
                        help_text="The type of date.",
                        max_length=255,
                        verbose_name="type",
                    ),
                ),
                (
                    "date",
                    models.DateTimeField(help_text="The date.", verbose_name="date"),
                ),
                (
                    "year",
                ...
                (
                    "day",
                    models.PositiveIntegerField(
                        blank=True, help_text="The day.", null=True, verbose_name="day"
                    ),
                ),
                (
                    "content_type",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="core_fuzzyd_content_1aa9ad_idx",
                    )
                ],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["content_type", "object_id"],
                        name="core_descri_content_af59ce_idx",
                    )
                ],
                "unique_together": {("type", "content_type", "object_id")},
            },
