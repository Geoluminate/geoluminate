    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', django.contrib.postgres.fields.ArrayField(base_field=research_vocabs.fields.ConceptField(verbose_name='type', vocabulary=geoluminate.contrib.measurements.choices.MeasurementRoles), help_text='Assigned roles for this contributor.', size=None, verbose_name='roles')),
                ...
                ('object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contributions', to='measurements.basemeasurement', verbose_name='measurement')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='contributors',
            field=models.ManyToManyField(help_text='The contributors to this measurement.', through='measurements.Contribution', to='contributors.contributor', verbose_name='contributors'),
        ),
        migrations.CreateModel(
            name='Date',
            fields=[
                ...
                ('type', research_vocabs.fields.ConceptField(verbose_name='type', vocabulary=geoluminate.contrib.measurements.choices.MeasurementDates)),
                ('object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='measurements.basemeasurement')),
            ],
            options={
                'verbose_name': 'date',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', research_vocabs.fields.ConceptField(verbose_name='type', vocabulary=geoluminate.contrib.measurements.choices.MeasurementDescriptions)),
                ('object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='measurements.basemeasurement')),
            ],
            options={
