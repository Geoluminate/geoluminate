...
from geoluminate.contrib.project import api
...
dataset_router.register(r"sites", api.SiteViewset)


# ============= NESTED SITE ROUTER =============
site_router = routers.NestedSimpleRouter(router, r"sites", lookup="site")
site_router.register(r"samples", api.SampleViewset)
