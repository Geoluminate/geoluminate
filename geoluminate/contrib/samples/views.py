...
from geoluminate.menus import SampleMenu
from geoluminate.views import BaseCRUDView, BaseDetailView, BaseListView
...
class SamplePlugin(TablePlugin):
    model = Sample
    ...
    menu = MenuItem(
        name=_("Samples"),
        icon="sample.svg",
        view_name="dataset-overview",
        template="samples/sample_menu.html",
    )
