...
class AdminDashboard(Dashboard):
    ...
    def __init__(self, **kwargs):
        ...
        self.children.append(
            ModelList(_('Literature Management'),
                      column=1,
                      collapsible=True,
                      models=('literature*', 'crossref*',),

                      ))
        self.children.append(
            ModelList(_('Instruments'),
                      column=2,
                      collapsible=True,
                      models=(
                'django_laboratory.*',
        ...
        self.children.append(
            Group(_('Django Earth Science'),
                  column=1,
                  collapsible=True,
                  children=[
                ModelList(_('GIS Plugins'),
                          column=1,
                          collapsible=True,
                          models=(
                    'earth_science.gis*',
                )),
                ModelList(_('Vocabularies'), models=(
                    'earth_science.vocab*',
                )),
            ],
            )
        ...
        self.children.append(
            ModelList(_('Controlled Vocabulary'),
                      column=2,
                      collapsible=True,
                      models=("controlled*",),
                      ))
        ...
        self.children.append(
            Group(_('Users and Authentication'),
                  column=3,
                  collapsible=True,
                  children=[
                ModelList(_('Authentication'),
                          column=3,
                          collapsible=True,
                          models=(
                    "user*",
                ...
                ModelList(_('Research Organizations'),
                          column=2,
                          collapsible=True,
                          models=("ror.*",),
                          )
