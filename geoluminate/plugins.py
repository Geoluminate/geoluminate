...
from geoluminate.core.view_mixins import HTMXMixin, RelatedObjectMixin
from geoluminate.menus import ContributorMenu, DatasetMenu, ProjectMenu, SampleMenu


class PluginMenuItem(MenuItem):
    template = "geoluminate/menus/detail/menu.html"


class PluggableView(RelatedObjectMixin, MetadataMixin, HTMXMixin, SingleObjectTemplateResponseMixin):
    menu = None
    name = None
    menu_check = True
