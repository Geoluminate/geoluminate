...
from django.contrib.sites.shortcuts import get_current_site
from main.tables import IntervalTable, HeatProductionTable, ConductivityTable, TemperatureTable, SiteTable
...
class PublicationListView(PublicationPaginateYearView, FilterView):
    ...
    def get_queryset(self):
        return super().get_queryset().prefetch_related('authors','sites', 'intervals','temperature_logs','conductivity_logs','heat_production_logs').exclude(published__year__isnull=True)
